...
"""
    ...
    def _params_snapshot(self):
        return {
            ...
            "adx_max": float(self.get_param("adx_max", 23.0)),
            "max_adx_slope": float(self.get_param("max_adx_slope", 1.0)),
            "ema_period": int(self.get_param("ema_period", 50)),
            "ema_slope_flat_max": float(self.get_param("ema_slope_flat_max", 0.0008)),
