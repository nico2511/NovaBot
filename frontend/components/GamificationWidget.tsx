...
export default function GamificationWidget() {
    ...
    return (
        <div className="group relative flex items-center gap-3 px-3 py-1.5 rounded-lg hover:bg-white/5 transition-colors cursor-help">
            ...
            {/* Hover Tooltip */}
            <div className="absolute top-full right-0 mt-2 w-64 p-4 bg-gray-900/95 backdrop-blur-xl border border-gray-700 rounded-xl shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 transform translate-y-2 group-hover:translate-y-0">
                    ...
                    {gamData.progress.next_level && (
                        <div className="pt-2 border-t border-gray-800">
                            <div className="flex justify-between text-xs mb-1">
                                <span className="text-gray-400">Target: {gamData.progress.next_level}</span>
                                <span className="text-white font-medium">${gamData.progress.required_balance}</span>
                            </div>
                            ...
                            <div className="text-right text-[10px] text-primary mt-1">
                                +${gamData.progress.remaining.toFixed(2)} needed
                            </div>
                        </div>
                    )}
                </div>
